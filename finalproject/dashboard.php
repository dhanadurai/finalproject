...
<body>
 <div class="row">
  ...
  <center> <img src="img/avatar.png" class="img img-circle"> </center>
   ...
   <form>
   <a href="logout.php" class="btn btn-danger" style="float: right; margin-right: 20px"> 
   Logout
   </a>
   </form>
   </div>
   ...
   <h5 style="font-weight: bold"> Welcome : ADMIN</h5>
   <div class="row">
    <div class="col-md-4">
	<div class="cc">
	 <center>
	<img src="img/navbar.png" class="img img-circle" style="height:50px" ><br>
	<?php
	$pc="select * from news";
	...
	?>
	<h3> Total Post </h3>
	<span class="badge" style=" background:white"> <?php echo $count_pc ?> </span>
	 </center>
</div>
...
<div class="cc">
	 ...
	 <center>
		 <img src="img/call.png" class="img img-circle" style="height:50px" ><br>
		 <?php
	$pc1="select * from contact";
	$run_p1=mysqli_query($con,$pc1);
	$count_pc1=mysqli_num_rows($run_p1);
	
	?>
	<h4> Contact </h3>
	<span class="badge" style=" background:white"><?php echo $count_pc1?>  </span>
	 </center>	 
	 </div>
	 </div>
    <div class="col-md-4"> 
	...
	<h4> Categories </h3>
	<span class="badge" style=" background:white"><?php echo $count_pc2?> </span>
	 </center>
</div>
	</div>
   </div>
