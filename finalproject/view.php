 ...
 <div class="row">
  ...
  <center> <img src="img/avatar.png" class="img img-circle"> </center>
   ...
   <h5><?php echo $get?></h5></center>
	...
	<th> <?php echo $no++?> </th>
	<th> <?php echo $name?> </th>
	<th> <a href="insertnews.php?id=<?php echo $id?>" class="btn btn-success"> Edit </a> &nbsp; <a href="delete.php?id=<?php echo $id?>" class="btn btn-danger">Delete </a></th>
